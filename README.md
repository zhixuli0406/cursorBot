...
- [運作原理](#運作原理)
- [快速開始](#快速開始)
  - [Docker 安裝（推薦）](#方式一docker推薦)
  - [本地安裝](#方式二本地安裝)
  - [AI 提供者設定](#4-設定-ai-提供者多模型支援)
  - [Gateway 設定](#5-gateway-設定原生應用連線)
- [使用流程](#使用流程)
- [指令說明](#指令說明)
  - [基礎指令](#基礎指令)
  - [AI 對話](#ai-對話)
  ...
  - [Gmail 整合](#gmail-整合)
  - [Google OAuth 常見問題](#google-oauth-常見問題)
  - [Skills Registry 技能市集](#skills-registry技能市集)
  - [多平台 Webhook 設定](#多平台-webhook-設定)
  - [RAG 檢索增強生成](#rag檢索增強生成)
  - [Agent 技能系統](#agent-技能系統)
  - [v0.3 進階功能](#v03-進階功能)
- [專案結構](#專案結構)
- [Discord 設定](#discord-設定)
- [Docker 終端機功能](#docker-終端機功能)
- [疑難排解](#疑難排解)
- [注意事項](#注意事項)
- [版本資訊](#版本資訊)
- [授權](#授權)
